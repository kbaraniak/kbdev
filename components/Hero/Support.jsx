            ...
            <div className="flex max-md:flex-col items-center justify-center">
                <ScrollReveal delay={100} className="w-full md:w-auto">
                    <a href="https://discord.gg/meKqTdUDDm">
                        <div className="mt-3 mx-2 w-full md:w-60 h-20 bg-[#5865F2] rounded-md text-center flex items-center justify-center hover:opacity-70 transition-opacity hover-lift hover-glow smooth-transition">
                ...
                <ScrollReveal delay={200} className="w-full md:w-auto">
                    <a href="mailto:kbdev@duck.com">
                        <div className="mt-3 mx-2 w-full md:w-60 h-20 bg-gray-700 rounded-md text-center flex items-center justify-center hover:opacity-70 transition-opacity hover-lift hover-glow smooth-transition">
                ...
                <ScrollReveal delay={300} className="w-full md:w-auto">
                    <a href="https://patreon.com/Klubuntu">
                        <div className="mt-3 mx-2 w-full md:w-60 h-20 bg-red-900 rounded-md text-center flex items-center justify-center hover:opacity-70 transition-opacity hover-lift hover-glow smooth-transition">
