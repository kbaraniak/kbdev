...
export default function AboutMe() {
  return (
    <section className="mt-3 flex flex-col justify-center items-center" id="aboutme">
      ...
      <div className="mt-3 flex flex-row items-center gap-6 p-6 rounded-lg max-w-4xl w-full">
        <div className="w-[175px] h-[175px] min-w-[175px] relative rounded-full overflow-hidden bg-gray-500 flex items-center justify-center">
