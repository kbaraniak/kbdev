  ...
  return (
    <section className="mt-3 min-w-[350px] flex flex-col justify-center items-center" id="aboutme">
      ...
      <ScrollReveal delay={200}>
        <div className="mt-3 flex flex-col md:flex-row items-center gap-6 p-6 rounded-lg max-w-4xl w-full" style={{background: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 255, 255, 0.1)'}}>
          <div className="w-[125px] h-[125px] min-w-[125px] md:w-[175px] md:h-[175px] md:min-w-[175px] relative rounded-full overflow-hidden bg-gray-500 flex items-center justify-center hover-scale">
