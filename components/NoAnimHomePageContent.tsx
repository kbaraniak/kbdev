      ...
      <main className="mt-10">
        ...
        <section className="mt-8 grid gap-10 items-center" id="websites-frontend">
          ...
          <div className="w-full flex flex-col items-center gap-3">
            <ProjectCard id="Ba-Car" website_url="https://ba-car.pl" stack={["astro", "css", "js"] as any} />
            <ProjectCard id="Klubuntu | Two Sides" website_url="https://klubuntu.eu.org" source_url="https://github.com/Klubuntu/klubuntu.social" stack={["astro", "css", "js"] as any} />
