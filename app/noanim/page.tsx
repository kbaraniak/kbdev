...
export const metadata: Metadata = {
  ...
  description: "Uproszczona wersja portfolio Kamila B. bez animacji i efektów - dla szybszego ładowania i lepszej dostępności. Frontend developer: React, Next.js, Tailwind CSS",
