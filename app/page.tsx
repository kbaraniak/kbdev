...
export const metadata: Metadata = {
  ...
  description: "Portfolio Kamila B. - frontend developer tworzący szybkie, nowoczesne strony internetowe. React, Next.js, Tailwind CSS. Zobacz projekty: Ba-Car, iTVT i więcej.",
